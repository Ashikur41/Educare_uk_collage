                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-block">
                                                <input class="form-control" name="course_slug" value="{{ $permalink->course_slug }}">
                                                <span class="text-info mt-1 d-block">Full Path : {{ url('/') }}/{{ $permalink->course_slug }}</span>
                                                @if ($errors->has('course_slug'))
                                                    <p class="text-danger"> {{ $errors->first('course_slug') }} </p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
