                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">{{__('Courses')}}
                                                <a data-text="{{__('Courses')}}" data-type="courses" class="addToMenus btn btn-info btn-sm float-right" href=""><i class="fas fa-plus"></i></a>
                                            </li>
