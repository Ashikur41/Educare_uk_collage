...
<div class="header-extra d-flex align-items-center">
    ...
    <?php if( $visibility->is_quote_page == 1): ?>
        <div class="navbar-btn">
            <a href="<?php echo e(route('front.quot')); ?>"><?php echo e(__('Application Form')); ?><i class="fal fa-long-arrow-right"></i></a>
        </div>
    <?php endif; ?>
</div><?php /**PATH E:\ASHIK_WORK 21-10-24\ASHOPAY\EDU-CARE\educaretc-development\educaretc-development\core\resources\views/front/partials/menu/nav-item.blade.php ENDPATH**/ ?>