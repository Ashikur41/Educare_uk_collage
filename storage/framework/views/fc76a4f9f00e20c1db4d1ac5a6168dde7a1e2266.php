                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo e(route('admin.permalinks.update')); ?>" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Page Name : Courses</label>
                                            <div class="d-block">
                                                <input class="form-control" name="course_slug" value="<?php echo e($permalink->course_slug); ?>">
                                                <span class="text-info mt-1 d-block">Full Path : <?php echo e(url('/')); ?>/<?php echo e($permalink->course_slug); ?></span>
                                                <?php if($errors->has('course_slug')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('course_slug')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u513097380/domains/educaretc.co.uk/public_html/core/resources/views/admin/settings/permalink.blade.php ENDPATH**/ ?>