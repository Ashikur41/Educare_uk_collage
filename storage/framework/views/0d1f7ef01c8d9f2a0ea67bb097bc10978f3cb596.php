			...
			<div class="col-lg-6 col-md-10 wow fadeInRight" data-wow-delay="0.3s">
				<div class="about-text-block pl-lg-5 mt-md-gap-60">
					<div class="section-title mb-40">
						<span class="title-tag"><?php echo e($sinfo->about_experince_yers); ?> - <?php echo e(__('Quality Education')); ?></span>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u513097380/domains/educaretc.co.uk/public_html/core/resources/views/front/about.blade.php ENDPATH**/ ?>