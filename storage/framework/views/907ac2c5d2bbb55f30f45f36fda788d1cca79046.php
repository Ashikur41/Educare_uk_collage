<?php $__env->startSection('meta-keywords', "$seo->course_meta_key"); ?>
<?php $__env->startSection('meta-description', "$seo->course_meta_desc"); ?>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-title-item text-center">
					<h2 class="title"><?php echo e(__('Course')); ?></h2>
						<ul class="breadcrumb-nav">
							<li class=""><a href="<?php echo e(route('front.index')); ?>"><?php echo e(__('Home')); ?> </a></li>
							<li class="active" aria-current="page"><?php echo e(__('Course')); ?></li>
						</ul>
				</div> <!-- page title -->
			</div>
		</div> <!-- row -->
	...
	<div class="container">
		<div class="row service-items justify-content-center">
			...
			<div class="col-lg-4 col-md-6 col-sm-8">
				<a href="<?php echo e(route('front.course.details', $item->slug)); ?>" class="service-item-eight mb-30 d-block">
					<div class="service-img" style="background-image: url(<?php echo e(asset('assets/front/img/course/'.$item->image)); ?>)"></div>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u513097380/domains/educaretc.co.uk/public_html/core/resources/views/front/course.blade.php ENDPATH**/ ?>