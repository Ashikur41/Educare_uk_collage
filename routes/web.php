...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::get("$permalink->course_slug", 'Front\FrontendController@course')->name('front.course');
    Route::get("$permalink->course_slug".'/{slug}', 'Front\FrontendController@course_details')->name('front.course.details');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Inner Page'], function () {
        ...
        // Course Route
        Route::get('/course', 'Admin\CourseController@course')->name('admin.course');
        Route::get('/course/add', 'Admin\CourseController@add')->name('admin.course.add');
        Route::post('/course/store', 'Admin\CourseController@store')->name('admin.course.store');
        Route::post('/course/delete/{id}/', 'Admin\CourseController@delete')->name('admin.course.delete');
